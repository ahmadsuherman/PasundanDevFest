...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/admin/members/{username}/edit', [MemberController::class, 'edit'])->name('members.edit');
    Route::patch('/admin/members/{username}/edit', [MemberController::class, 'update'])->name('members.update');
