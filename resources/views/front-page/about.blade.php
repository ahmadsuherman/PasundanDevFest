            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="p-6 border rounded-lg shadow">
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('img/Ahmad.jpeg') }}" alt="Ahmad Suherman" class="w-24 h-24 rounded-full shadow">
                    </div>
                    ...
                    <p class="mt-4 text-sm text-gray-700 text-center">
                        Ahmad Suherman adalah seorang Web Developer dengan minat yang mendalam dalam menciptakan pengalaman pengguna yang interaktif dan menarik.
                    </p>
                </div>
                ...
                <div class="p-6 border rounded-lg shadow">
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('img/Melinda.jpeg') }}" alt="Melinda Sulaiman" class="w-24 h-24 rounded-full shadow">
                    </div>
                ...
                <div class="p-6 border rounded-lg shadow">
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('img/Naufal.jpg') }}" alt="Naufal Zul Faza" class="w-24 h-24 rounded-full shadow">
                    </div>
                ...
                <div class="p-6 border rounded-lg shadow">
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('img/Febi.jpeg') }}" alt="Febi Alia Rahman" class="w-24 h-24 rounded-full shadow">
                    </div>
                ...
                <div class="p-6 border rounded-lg shadow">
                    <div class="flex justify-center mb-4">
                        <img src="{{ asset('img/Kholish.jpeg') }}" alt="Muhammad Kholish Kamil" class="w-24 h-24 rounded-full shadow">
                    </div>
