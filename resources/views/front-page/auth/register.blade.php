<x-frontPage.layout>
    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto" style="margin-top: -50px;">
        <form class="w-full max-w-md bg-transparent">
            ...
            <div class="relative flex items-center mt-8">
                ...
                <input type="text" class="block w-full py-3 text-gray-700 border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username">
            </div>
            ...
            <div class="relative flex items-center mt-6">
                ...
                <input type="email" class="block w-full py-3 text-gray-700 border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address">
            </div>
            ...
            <div class="relative flex items-center mt-4">
                ...
                <input type="password" class="block w-full px-10 py-3 text-gray-700 border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password">
            </div>
            ...
            <div class="relative flex items-center mt-4">
                ...
                <input type="password" class="block w-full px-10 py-3 text-gray-700 border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Confirm Password">
            </div>

            <div class="mt-6">
                <h3 class="text-gray-700 dark:text-gray-300">Register as:</h3>
                <div class="flex items-center mt-2">
                    <label class="flex items-center text-gray-700 dark:text-gray-300">
                        <input type="radio" name="role" value="member" class="form-radio h-4 w-4 text-blue-500">
                        <span class="ml-2">Member</span>
                    </label>
                    <label class="flex items-center ml-6 text-gray-700 dark:text-gray-300">
                        <input type="radio" name="role" value="speaker" class="form-radio h-4 w-4 text-blue-500">
            ...
            <a href="#" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or Sign Up
                with email</a>
        ...
        <a href="#" class="flex items-center justify-center mt-4 text-gray-700 transition-colors duration-300 transform border rounded-lg bg-gray-100 dark:border-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600">
    <div class="px-4 py-2">
    ...
    <span class="w-5/6 px-4 py-3 font-bold text-center">Sign Up with Google</span>
                ...
                <div class="mt-6 text-center ">
                    <span>
                        Already have an account? <a href="{{ url('login') }}" class="text-sm text-blue-500 hover:underline dark:text-blue-400">Login</a>
                    </span>
                </div>
            </div>
        </form>
