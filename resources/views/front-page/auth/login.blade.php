    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto" style="margin-top: -50px;">
        <form class="w-full max-w-md">
            ...
            <div class="relative flex items-center mt-8">
                ...
                <input type="email" class="block w-full py-3 text-gray-700 bg-transparent border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address">
            </div>
            ...
            <div class="relative flex items-center mt-4">
                ...
                <input type="password" class="block w-full px-10 py-3 text-gray-700 bg-transparent border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password">
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <span>
                    Don’t have an account yet? <a href="{{ url('register') }}" class="text-sm text-blue-500 hover:underline dark:text-blue-400">Sign Up</a>
                    </span>
                </div>
            </div>
        </form>
