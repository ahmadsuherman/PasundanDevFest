<x-backPage.layout>
    ...
    <form data-form="validate" action="{{ route('accounts.update') }}" method="post" class="bg-white p-6">
        @csrf
        @method('PATCH')
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-1">
            <div>
                ...
                <div class="mt-2 flex items-center gap-x-3">
                    <img class="img-preview size-24 text-gray-300" src="https://www.shutterstock.com/image-vector/avatar-gender-neutral-silhouette-vector-600nw-2470054311.jpg" />
        ...
        <div>
            <label for="bio" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Links</label>
