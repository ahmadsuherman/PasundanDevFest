<x-backPage.layout>
    ...
    <form data-form="validate" action="/admin/categories/create" method="post" class="bg-white p-6">
        @csrf
        <h3 class="text-lg font-medium leading-none text-gray-900 dark:text-white">Tambah {{ $title }}</h3>
