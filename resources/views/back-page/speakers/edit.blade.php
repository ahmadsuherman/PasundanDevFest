<x-backPage.layout>
    ...
    <form data-form="validate" action="{{ route('speakers.update', $speaker->username) }}" method="post" class="bg-white p-6" enctype="multipart/form-data">
        @csrf
        @method('PATCH')

        <input type="hidden" name="oldAvatar" value="{{ $speaker->avatar }}">
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-1">
            <div>
                ...
                <div class="mt-2 flex items-center gap-x-3">
                    <img class="img-preview size-24 text-gray-300 rounded-full" src="{{ getAvatar($speaker->avatar) }}" alt="{{ old('fullname') }}"/>
