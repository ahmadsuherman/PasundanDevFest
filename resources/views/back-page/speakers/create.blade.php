<x-backPage.layout>
    ...
    <form data-form="validate" action="{{ route('speakers.store') }}" method="post" class="bg-white p-6">
        ...
        <button type="submit" class="mt-4 p-6 px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
