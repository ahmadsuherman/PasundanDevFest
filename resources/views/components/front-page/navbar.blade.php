<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <img class="h-18 w-24" src="{{ asset('logoapp.svg') }}" alt="PasundanDevFest">
            </a>
            <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <x-front-page.nav-link href="/about" :active="request()->is('about')">About</x-front-page.nav-link>
                <x-front-page.nav-link href="/events" :active="request()->is('events')">Events</x-front-page.nav-link>
                <x-front-page.nav-link href="/speakers" :active="request()->is('speakers')">Speakers</x-front-page.nav-link>
        ...
        <div class="hidden md:block">
            ...
            <div class="relative ml-3">
                ...
                <a href="/members/dashboard" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Dashboard</a>
                @elseif(Auth()->user()->roles == 'Speakers')
                <a href="/speakers/dashboard" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Dashboard</a>
                @endif
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="mt-3 space-y-1 px-2">
            @if(Auth()->user()->roles == 'Admin')
            <a href="{{ url('admin/dashboard') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Dashboard</a>
            @elseif(Auth()->user()->roles == 'Members')
            <a href="{{ url('members/dashboard') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Dashboard</a>
            @elseif(Auth()->user()->roles == 'Speakers')
            <a href="{{ url('speakers/dashboard') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Dashboard</a>
            @endif
            <form action="/logout" method="POST">
                @csrf
